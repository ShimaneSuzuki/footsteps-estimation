...
\begin{figure}
    ...
    \includegraphics[page=1,width=\linewidth]{figs/matome.pdf}
    \includegraphics[page=2,width=\linewidth]{figs/matome.pdf}
    \includegraphics[page=3,width=\linewidth]{figs/matome.pdf}
...
\begin{thebibliography}{99}
  ...
  \bibitem{gait_analyse} Götz-Neumann K：観察による歩行分析．月城慶一，他（訳），医
学書院，東京，2005，pp. 5‒80.
...
\bibitem{funk} Christopher Funk, Savinay Nagendra, Jesse Scott, Bharadwaj Ravichandran, John H. Challis, Robert T. Collins, Yanxi Liu, Learning Dynamics from Kinematics: Estimating 2D Foot Pressuer Maps from Video Frames,Cornell University arXiv.org,2018.
